...
*/
public class AccountNameDuplicateException extends LogicException {
    public AccountNameDuplicateException(String message) {
        super(InnerRPC.EN_INNER_CODE.E_INNER_SUSS, Code.En_Code.E_ACCOUNT_NAME_DUPLICATE_ERROR, message);
    }
}
