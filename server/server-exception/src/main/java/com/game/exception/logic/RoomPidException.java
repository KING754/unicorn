...
*/
public class RoomPidException extends LogicException {
    public RoomPidException(String message) {
        super(InnerRPC.EN_INNER_CODE.E_INNER_SUSS, Code.En_Code.E_ROOM_PID_ERROR, message);
    }
}
