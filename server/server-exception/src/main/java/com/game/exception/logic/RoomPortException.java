...
*/
public class RoomPortException extends LogicException {
    public RoomPortException(String message) {
        super(InnerRPC.EN_INNER_CODE.E_INNER_SUSS, Code.En_Code.E_ROOM_PORT_ERROR, message);
    }
}
